                ...
                <td width="592" valign="top" class="tablecomment_l_r">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <?
                                        ...
                                        $strsql = $strsql." WHERE tblshop.shopid=".$_GET['id']."";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="1">
                                  ...
                                  <tr>
                                    <td align="center" class="tbline_b_dash">อ่าวนางอีโคอินน์</td>
                                  </tr>
                                  <tr>
                                    <td align="center" class="tbline_b_dash">สถานที่ตั้ง :<?=$data['location']?></td>
                                  </tr>
                                  <tr>
                                    <td align="center" class="tbline_b_dash">Emial : aonangeconinn@gmail.com</td>
                                  </tr>
                                </table></td>
