                ...
                <td width="592" valign="top" class="tablecomment_l_r">
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <?
                                        ...
                                        $strsql = $strsql." WHERE tblnews.newsid=".$_GET['id']."";
...
<table width="100%" border="0" cellspacing="2" cellpadding="1">
                      ...
                      <tr>
                        <td height="42" background="images/bbar.gif" class="txtwhitebold"><?=$data['newsname']?></td>
                      </tr>
                      <tr>
                        <td>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <td valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="1">
                                  ...
                                  <tr>
                                    <td>
                                        ...
                                        <img src="picture/<?=$data['picshow01']?>" width="400" height="300" />
                                        <? } ?>                                                                    
                                    </td>
                                  </tr>
                                  <tr>
                                    <td class="tbline_b_dash"><?=$data['detail']?></td>
                                  </tr>
                                </table></td>
