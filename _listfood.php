...
<table width="100%" border="0" cellspacing="2" cellpadding="1">
                      ...
                      <tr>
                        <td height="42" background="images/bbar.gif" class="txtwhitebold">ร้านอาหาร จังหวัดกระบี่</td>
                      </tr>
                      <tr>
                        <td>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="1">
								  ...
								  <?
                                        $strsql="SELECT tblshop.* FROM tblshop  ";
                                        $strsql = $strsql." ORDER BY tblshop.shopid DESC LIMIT 0,6 ";
                                  ...
                                  ?>                                
                                    ...
                                    <a class="a1" href="shopdetail.php?id=<?=$row['shopid']?>" target="_blank"><img src="picture/<?=$row['picture01']?>" width="160" height="120" /><br/></a>                                    
                                    </td>
                              		<td width="80%" valign="top" class="tbline_b_dash"><table width="100%" border="0" cellspacing="2" cellpadding="1">
                                      <tr>
                                        <td valign="top" class="txt04"><a class="a1" href="shopdetail.php?id=<?=$row['shopid']?>" target="_blank">
                                          <?=$row['shopname']?>
                                        </a></td>
                                      </tr>
                                      <tr>
