...
<?	
	if ($_POST['save']=='yes') {
		$strsql = "UPDATE tblmember SET titlename ='".$_POST['titlename']."',membername ='".$_POST['membername']."',address ='".$_POST['address']."',provinceid ='".$_POST['provinceid']."',email ='".$_POST['email']."',telephone ='".$_POST['telephone']."',zip ='".$_POST['zip']."' WHERE username ='".$_POST['musername']."' ";
		mysql_query($strsql) or die(mysql_error());
		$strsql = "UPDATE tbluser SET upassword ='".$_POST['mpassword']."',fullname ='".$_POST['membername']."' WHERE username ='".$_POST['musername']."' ";
				mysql_query($strsql) or die(mysql_error());				
					echo"<script language=javascript>";
					echo"alert('บันทึกข้อมูลการแก้ไขข้อมูลสมาชิกเรียบร้อยครับ')"; 
					echo"</script>";
                  ...
                  <table width="100%" border="0" cellspacing="1" cellpadding="1">
                    ...
                    <tr>
                      ...
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="musername" type="text" class="readonly" readonly="readonly" value="<?=$_SESSION[username]?>" id="musername" size="20" maxlength="20" />
                      </label></td>
                      </tr>
                    <tr>
                      <td align="right" bgcolor="#FFFFFF" class="tbline_b_dash">รหัสผ่าน :</td>
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="mpassword" type="password" class="inputtext_gold" value="<?=$data['upassword']?>" id="mpassword" size="20" maxlength="20" />
                      </label></td>
                      </tr>
                    <tr>
                      <td align="right" bgcolor="#FFFFFF" class="tbline_b_dash">ยืนยันรหัสผ่าน :</td>
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="mrepassword" type="password" class="inputtext_gold" value="<?=$data['upassword']?>" id="mrepassword" size="20" maxlength="20" />
                      </label></td>
                      </tr>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
						<select id="titlename" name="titlename">
                                    ...
                                    ?>
                                    <option value="<?=$row[titlename]?>"  <?=$data[titlename]==$row[titlename] ? "selected = selected" : "''";?> ><?=$row[titlename]?></option>
                                    <?}?>
                            </select>                      
                        <input name="membername" type="text" class="inputtext_gold" value="<?=$data['membername']?>" id="membername" size="40" maxlength="120" />
                      </label></td>
                      </tr>
                    <tr>
                      <td align="right" valign="top" bgcolor="#FFFFFF" class="tbline_b_dash">ที่อยู่ :</td>
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <textarea name="address" cols="50" rows="3" class="inputtext_gold" value="<?=$data['address']?>" id="address"></textarea>
                      </label></td>
                      </tr>
                    <tr>
                      ...
                      <td width="53%" align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
						<select id="provinceid" name="provinceid" class="inputtext">
                                    <?
                                       ...
                                       while ($row = @mysql_fetch_assoc($myrs)){
                                    ?>
                                    <option value="<?=$row[provinceid]?>"  <?=$data[provinceid]==$row[provinceid] ? "selected = selected" : "''";?> ><?=$row[provincename]?></option>
                                    <?}?>
                            </select>                      </label></td>
                      </tr>
                    <tr>
                      ...
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="telephone" type="text" class="inputtext_gold" value="<?=$data['telephone']?>" id="telephone" size="10" maxlength="10" onkeypress="key_onkeypress()" />
                      </label></td>
                      </tr>
                    <tr>
                      <td align="right" bgcolor="#FFFFFF" class="tbline_b_dash">รหัสไปรษณีย์ :</td>
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="zip" type="text" class="inputtext_gold" value="<?=$data['zip']?>" id="zip" size="5" maxlength="5" onkeypress="key_onkeypress()" />
                      </label></td>
                      </tr>
                    <tr>
                      <td align="right" bgcolor="#FFFFFF" class="tbline_b_dash">อีเมลล์  :</td>
                      <td align="left" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input name="email" type="text" class="inputtext_gold"  value="<?=$data['email']?>" id="email" size="50" maxlength="50" />
                      </label></td>
                      </tr>
                    <tr>
                      <td colspan="2" align="center" bgcolor="#FFFFFF" class="tbline_b_dash"><label>
                        <input type="submit" name="button2" id="button2" value="บันทึกข้อมูลการแก้ไข" />
                      </label>
                        <label>
